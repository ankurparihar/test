<svg class="theme--dark"
	...
	xmlns:xlink="http://www.w3.org/1999/xlink" fill="none" width="1000" height="330">
	<style>
			.gauge-base {
				opacity: 0.1
			}
	...
	<svg class="guage-div guage-perf guage-invisible" viewBox="0 0 200 200" width="200" height="200" x="300" y="0">
	...
	<svg class="guage-div guage-acc guage-invisible" viewBox="0 0 200 200" width="200" height="200" x="300" y="0">
		<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
	...
	<svg class="guage-div guage-best guage-invisible" viewBox="0 0 200 200" width="200" height="200" x="300" y="0">
		<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
	...
	<svg class="guage-div guage-seo guage-green" viewBox="0 0 200 200" width="200" height="200" x="300" y="0">
		<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"></circle>
	...
	<svg class="guage-div guage-pwa " viewBox="0 0 200 200" width="200" height="200" x="500" y="0">
		<svg viewBox="0 0 60 60" width="112" height="112" x="44" y="4">
			...
			<g stroke="none" fill-rule="nonzero">
				...
				<!-- No badges. -->
				<rect class="lh-gauge--pwa__component lh-gauge--pwa__na-line lh-gauge--pwa__visible" fill="#FFFFFF" x="20" y="32" width="20" height="4" rx="2"></rect>
